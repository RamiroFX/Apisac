...
public class Exportar {
    ...
    public Exportar(ArrayList<Producto> productos) {
        this.sdfs = new SimpleDateFormat("MM-yyyy");
    ...
    public void exportar() {
        ...
        fechaCaja.createCell(0).setCellValue(new HSSFRichTextString(PRODUCT_NAME));
        ...
        for (CierreCaja cierreCaja : productos) {
            ...
            if (currentMonth != newMonth) {
                ...
                sheet.add(workbook.createSheet(sdfs.format(calendar.getTime())));
                monthCursor++;
                fila = 0;
            }
            fila++;//PARA DAR ESPACIO
            //CREAR FECHA DE CAJA
            Row fechaCaja = sheet.get(monthCursor).createRow(fila);
            fechaCaja.createCell(0).setCellValue(new HSSFRichTextString("Fecha:"));
            fechaCaja.createCell(1).setCellValue(cierreCaja.getCaja().getTiempoCierre());
            fechaCaja.getCell(1).setCellStyle(dateCellStyle);
            fila++;
            //FUNCIONARIOS
            Row funcionarioApertura = sheet.get(monthCursor).createRow(fila);
            sheet.get(monthCursor).addMergedRegion(new CellRangeAddress(fila, fila, 0, 1));
            sheet.get(monthCursor).addMergedRegion(new CellRangeAddress(fila, fila, 2, 3));
            ...
            fila++;
            Row funcionarioCierre = sheet.get(monthCursor).createRow(fila);
            sheet.get(monthCursor).addMergedRegion(new CellRangeAddress(fila, fila, 0, 1));
            sheet.get(monthCursor).addMergedRegion(new CellRangeAddress(fila, fila, 2, 3));
            ...
            Row cabeceraCajas = sheet.get(monthCursor).createRow(fila);
            sheet.get(monthCursor).addMergedRegion(new CellRangeAddress(fila, fila, 0, 2));
            sheet.get(monthCursor).addMergedRegion(new CellRangeAddress(fila, fila, 3, 5));
            sheet.get(monthCursor).addMergedRegion(new CellRangeAddress(fila, fila, 6, 8));
            ...
            Row subCabeceraCajas = sheet.get(monthCursor).createRow(fila);
            ...
            for (Moneda moneda : monedas) {
                Row arqueoCajas = sheet.get(monthCursor).createRow(fila);
                fila++;
            ...
            //TOTALES
            Row totales = sheet.get(monthCursor).createRow(fila);
            ...
            sheet.get(monthCursor).addMergedRegion(cellRangeAddress1);
            sheet.get(monthCursor).addMergedRegion(cellRangeAddress2);
            sheet.get(monthCursor).addMergedRegion(cellRangeAddress3);
            ...
            //BORDE para totales
            HSSFRegionUtil.setBorderTop(CellStyle.BORDER_THIN, cellRangeAddress1, sheet.get(monthCursor), workbook);
            HSSFRegionUtil.setBorderLeft(CellStyle.BORDER_THIN, cellRangeAddress1, sheet.get(monthCursor), workbook);
            HSSFRegionUtil.setBorderRight(CellStyle.BORDER_THIN, cellRangeAddress1, sheet.get(monthCursor), workbook);
            HSSFRegionUtil.setBorderBottom(CellStyle.BORDER_THIN, cellRangeAddress1, sheet.get(monthCursor), workbook);
            totales.getCell(2).setCellStyle(style7);
            HSSFRegionUtil.setBorderTop(CellStyle.BORDER_THIN, cellRangeAddress2, sheet.get(monthCursor), workbook);
            HSSFRegionUtil.setBorderLeft(CellStyle.BORDER_THIN, cellRangeAddress2, sheet.get(monthCursor), workbook);
            HSSFRegionUtil.setBorderRight(CellStyle.BORDER_THIN, cellRangeAddress2, sheet.get(monthCursor), workbook);
            HSSFRegionUtil.setBorderBottom(CellStyle.BORDER_THIN, cellRangeAddress2, sheet.get(monthCursor), workbook);
            totales.getCell(5).setCellStyle(style7);
            HSSFRegionUtil.setBorderTop(CellStyle.BORDER_THIN, cellRangeAddress3, sheet.get(monthCursor), workbook);
            HSSFRegionUtil.setBorderLeft(CellStyle.BORDER_THIN, cellRangeAddress3, sheet.get(monthCursor), workbook);
            HSSFRegionUtil.setBorderRight(CellStyle.BORDER_THIN, cellRangeAddress3, sheet.get(monthCursor), workbook);
            HSSFRegionUtil.setBorderBottom(CellStyle.BORDER_THIN, cellRangeAddress3, sheet.get(monthCursor), workbook);
            ...
            Row totalEgreso = sheet.get(monthCursor).createRow(fila);
            ...
            Row totalIngreso = sheet.get(monthCursor).createRow(fila);
            ...
            fila++;
            //EGRESO+DEPOSITADO
            Row egresoDeposito = sheet.get(monthCursor).createRow(fila);
            ...
            sheet.get(monthCursor).addMergedRegion(new CellRangeAddress(fila, fila, 0, 1));
            sheet.get(monthCursor).autoSizeColumn(1);
            sheet.get(monthCursor).autoSizeColumn(2);
            sheet.get(monthCursor).autoSizeColumn(3);
            sheet.get(monthCursor).autoSizeColumn(4);
            sheet.get(monthCursor).autoSizeColumn(5);
            sheet.get(monthCursor).autoSizeColumn(6);
            sheet.get(monthCursor).autoSizeColumn(7);
            sheet.get(monthCursor).autoSizeColumn(8);
            sheet.get(monthCursor).autoSizeColumn(9);
        ...
        fila = 0;
        sheet.add(workbook.createSheet(RESUMEN));
        monthCursor++;
        ...
        Row fechaInicio = sheet.get(monthCursor).createRow(fila);
        ...
        fila++;
        Row fechaFin = sheet.get(monthCursor).createRow(fila);
        ...
        Row resumenTotalEgresos = sheet.get(monthCursor).createRow(fila);
        ...
        Row resumenTotalIngresos = sheet.get(monthCursor).createRow(fila);
        ...
        Row resumenTotalDepo = sheet.get(monthCursor).createRow(fila);
        ...
        sheet.get(monthCursor).autoSizeColumn(0);
        sheet.get(monthCursor).autoSizeColumn(1);
